...
os.environ["CONTROL12_DATA_DIR"] = tempfile.mkdtemp(prefix="control12-commercial-tests-")
...
def test_commercial_flow():
    ...
    org = client.post(
        "/api/organizations",
        json={"name": "Test Org", "slug": "test-org", "plan": "developer"},
    )
    ...
    ev = client.post(
        f"/api/releases/{release['id']}/evidence",
        json={
